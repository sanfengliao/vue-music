<template>
   <transition name="list-fade">
       <div class="playlist" v-show="showFlag" @click="hide">
           <div class="list-wrapper" @click.stop>
               ...
               <scroll ref="listContent" class="list-content" :data="sequenceList">
                   <transition-group name="list" tag="ul">
                       <li ref="itemList" class="item" v-for="(item,index) in sequenceList" :key="index" @click="selectItem(item, index)">
           ...
           <confirm ref="confirm" text="是否清空" @confirm="confirmClear"></confirm>
...
<script>
    ...
    export default {
        ...
        computed:{
          ...
          ...mapGetters(['sequenceList', 'currentSong', 'mode', 'playHistory'])
        },
        methods: {
          show() {
            this.showFlag = true;
